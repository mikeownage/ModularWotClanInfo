...
public class GetPossibleClans extends SwingWorker<Vector<PossibleClan>, Vector<PossibleClan>> {
    ...
    {
        URL URL = new URL("http://worldoftanks."+gui.getServerRegion()+"/community/clans/api/1.1/?source_token=Intellect_Soft-WoT_Mobile-site&search="+this.searchTagName.replace(" ", "%20")+"&offset=0&limit=10");
